          ...
          >
            <div className="mb-8 sm:mb-0">
              ...
              <ul className="space-y-2 sm:space-y-3">
                <li>
                  <a href="mailto:januarhaykal7@student.upi.edu" className="text-base sm:text-lg hover:text-white transition-colors duration-300">
                    januarhaykal7@student.upi.edu
                  </a>
                </li>
                <li>
          ...
          >
            <div className="mb-8 sm:mb-0">
              ...
              <ul className="flex space-x-6">
                <li>
                  <a href="https://www.linkedin.com/in/januar-haykal-39570537b/" className="hover:text-white transition-colors duration-300">
                ...
                <li>
                  <a href="https://github.com/kalmwmandi" className="hover:text-white transition-colors duration-300">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                ...
                <li>
                  <a href="https://www.instagram.com/noturkall/" className="hover:text-white transition-colors duration-300">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
